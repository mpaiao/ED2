...
untab <<- list( cm            = "c*m"
              ...
              , gwokgodec     = "g*W^phantom(1)*k*g^{-1}*d*e*c^{-1}"
              , hpa           = "h*P*a"
              ...
              , kgwom2odec    = "k*g*W^phantom(1)*m^{-2}*d*e*c^{-1}"
...
i.untab <<- list( cm            = "c*m^{-1}"
                ...
                , gwokgodec     = "k*g^phantom(1)*d*e*c^phantom(1)*k*g*W^{-1}"
                , hpa           = "h*P*a^{-1}"
                ...
                , kgwom2odec    = "m^{2}*d*e*c^phantom(1)*k*g*W^{-1}"
