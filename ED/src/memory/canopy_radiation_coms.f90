...
module canopy_radiation_coms
   ...
   !---------------------------------------------------------------------------------------!
   !      This is the relative projected area.  We save it in single precision because we  !
   ! only use it outside the canopy radiation solver.                                      !
   !---------------------------------------------------------------------------------------!
   real(kind=4), dimension(n_pft) :: eproj_light
   !---------------------------------------------------------------------------------------!
