...
! mortality
           ...
           call getConfigREAL  ('escorch','pft',i,rval,texist)
           if(texist) escorch   (myPFT) = sngloff(rval,tiny_offset)
           ...
           if(texist) fx_rck_pft(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('fx_pck_pft','pft',i,rval,texist)
           if(texist) fx_pck_pft(myPFT) = sngloff(rval,tiny_offset)
...
! plant hydraulic variables
           ...
           if(texist) leaf_water_sat(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('wood_water_sat','pft',i,rval,texist)
           if(texist) wood_water_sat(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('bark_water_sat','pft',i,rval,texist)
           if(texist) bark_water_sat(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('leaf_water_cap','pft',i,rval,texist)
           if(texist) leaf_water_cap(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('wood_water_cap','pft',i,rval,texist)
           if(texist) wood_water_cap(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('leaf_rwc_min','pft',i,rval,texist)
           if(texist) leaf_rwc_min(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('wood_rwc_min','pft',i,rval,texist)
           if(texist) wood_rwc_min(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('leaf_psi_min','pft',i,rval,texist)
           if(texist) leaf_psi_min(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('wood_psi_min','pft',i,rval,texist)
           if(texist) wood_psi_min(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('leaf_psi_tlp','pft',i,rval,texist)
           if(texist) leaf_psi_tlp(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('wood_psi_tlp','pft',i,rval,texist)
           if(texist) wood_psi_tlp(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('leaf_psi_osmotic','pft',i,rval,texist)
           if(texist) leaf_psi_osmotic(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('wood_psi_osmotic','pft',i,rval,texist)
           if(texist) wood_psi_osmotic(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('leaf_elastic_mod','pft',i,rval,texist)
           if(texist) leaf_elastic_mod(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('wood_elastic_mod','pft',i,rval,texist)
           if(texist) wood_elastic_mod(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('wood_Kmax','pft',i,rval,texist)
           if(texist) wood_Kmax(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('wood_Kexp','pft',i,rval,texist)
           if(texist) wood_Kexp(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('wood_psi50','pft',i,rval,texist)
           if(texist) wood_psi50(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('vessel_curl_factor','pft',i,rval,texist)
           if(texist) vessel_curl_factor(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('stoma_lambda','pft',i,rval,texist)
           if(texist) stoma_lambda(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('stoma_beta','pft',i,rval,texist)
           if(texist) stoma_beta(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('stoma_psi_b','pft',i,rval,texist)
           if(texist) stoma_psi_b(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('stoma_psi_c','pft',i,rval,texist)
           if(texist) stoma_psi_c(myPFT) = sngloff(rval,tiny_offset)
           ...
           if(texist) leaf_shed_rate(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('leaf_grow_rate','pft',i,rval,texist)
           if(texist) leaf_grow_rate(myPFT) = sngloff(rval,tiny_offset)
     ...
     ! Sapwood area
           ...
           if (texist) b1SA(myPFT) = sngloff(rval,tiny_offset)
           call getConfigREAL  ('b2SA','pft',i,rval,texist)
           if (texist) b2SA(myPFT) = sngloff(rval,tiny_offset)
...
!        if(texist) visible_fraction_dif = sngloff(rval,tiny_offset)
  ...
  if(ntag .ge. 1) then
     do i=1,ntag
        ...
        if (texist)  then
           r_stsc_o = sngloff(rval,tiny_offset)
           r_stsc_l = sngloff(rval,tiny_offset)
        end if
        call getConfigREAL  ('r_stsc_l','decomposition',i,rval,texist)
        if(texist)  r_stsc_l = sngloff(rval,tiny_offset)
        call getConfigREAL  ('r_stsc_o','decomposition',i,rval,texist)
        if(texist)  r_stsc_o = sngloff(rval,tiny_offset)
        ...
        call getConfigREAL  ('rh_moyano12_a0','decomposition',i,rval,texist)
        if(texist)  rh_moyano12_a0 = sngloff(rval,tiny_offset)
        call getConfigREAL  ('rh_moyano12_a1','decomposition',i,rval,texist)
        if(texist)  rh_moyano12_a1 = sngloff(rval,tiny_offset)
        call getConfigREAL  ('rh_moyano12_a2','decomposition',i,rval,texist)
        if(texist)  rh_moyano12_a2 = sngloff(rval,tiny_offset)
        call getConfigREAL  ('rh_active_depth','decomposition',i,rval,texist)
        if(texist)  rh_active_depth = sngloff(rval,tiny_offset)
        call getConfigREAL  ('rh0','decomposition',i,rval,texist)
        if(texist)  rh0 = sngloff(rval,tiny_offset)
        call getConfigREAL  ('rh_p_smoist','decomposition',i,rval,texist)
        if(texist)  rh_p_smoist = sngloff(rval,tiny_offset)
        call getConfigREAL  ('rh_p_oxygen','decomposition',i,rval,texist)
        if(texist)  rh_p_oxygen = sngloff(rval,tiny_offset)
        call getConfigREAL  ('rh_q10','decomposition',i,rval,texist)
        if(texist)  rh_q10 = sngloff(rval,tiny_offset)
...
!        call getConfigREAL  ('ntol','fusefiss',i,rval,texist)
  ...
  if(ntag .ge. 1) then
     do i=1,ntag
        ...
        if(texist) fh_f0001      = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fh_f0010'    ,'disturbance',i,rval,texist)
        if(texist) fh_f0010      = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fh_f0100'    ,'disturbance',i,rval,texist)
        ...
        if(texist) fi_lu_ignd   = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fi_sf_maxage','disturbance',i,rval,texist)
        if(texist) fi_sf_maxage = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fi_lu_exp'   ,'disturbance',i,rval,texist)
        if(texist) fi_lu_exp    = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fi_lu_upr'   ,'disturbance',i,rval,texist)
        if(texist) fi_lu_upr    = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fi_hdi_exp'  ,'disturbance',i,rval,texist)
        if(texist) fi_hdi_exp   = sngloff(rval,tiny_offset)
        ...
        if(texist) fs_rhv_upr   = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fs_rhv_exp'  ,'disturbance',i,rval,texist)
        if(texist) fs_rhv_exp   = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fs_smpot_lwr','disturbance',i,rval,texist)
        if(texist) fs_smpot_lwr = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fs_smpot_upr','disturbance',i,rval,texist)
        if(texist) fs_smpot_upr = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fs_smpot_exp','disturbance',i,rval,texist)
        if(texist) fs_smpot_exp = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fs_temp_lwr' ,'disturbance',i,rval,texist)
        if(texist) fs_temp_lwr  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fs_temp_upr' ,'disturbance',i,rval,texist)
        if(texist) fs_temp_upr  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fs_temp_exp' ,'disturbance',i,rval,texist)
        if(texist) fs_temp_exp  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fs_lbr_slp'  ,'disturbance',i,rval,texist)
        ...
        if(texist) fx_a0001     = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_a0010'    ,'disturbance',i,rval,texist)
        if(texist) fx_a0010     = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_a0100'    ,'disturbance',i,rval,texist)
        if(texist) fx_a0100     = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_rmfac'    ,'disturbance',i,rval,texist)
        if(texist) fx_rmfac     = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_tlh_slope','disturbance',i,rval,texist)
        if(texist) fx_tlh_slope = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_tlc_slope','disturbance',i,rval,texist)
        if(texist) fx_tlc_slope = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_pmtau_di' ,'disturbance',i,rval,texist)
        if(texist) fx_pmtau_di  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_pmtau_ds' ,'disturbance',i,rval,texist)
        if(texist) fx_pmtau_ds  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0001_di' ,'disturbance',i,rval,texist)
        if(texist) fx_c0001_di  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0001_ds' ,'disturbance',i,rval,texist)
        if(texist) fx_c0001_ds  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0001_mi' ,'disturbance',i,rval,texist)
        if(texist) fx_c0001_mi  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0001_ms' ,'disturbance',i,rval,texist)
        if(texist) fx_c0001_ms  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0010_di' ,'disturbance',i,rval,texist)
        if(texist) fx_c0010_di  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0010_ds' ,'disturbance',i,rval,texist)
        if(texist) fx_c0010_ds  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0010_mi' ,'disturbance',i,rval,texist)
        if(texist) fx_c0010_mi  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0010_ms' ,'disturbance',i,rval,texist)
        if(texist) fx_c0010_ms  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0100_di' ,'disturbance',i,rval,texist)
        if(texist) fx_c0100_di  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0100_ds' ,'disturbance',i,rval,texist)
        if(texist) fx_c0100_ds  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0100_mi' ,'disturbance',i,rval,texist)
        if(texist) fx_c0100_mi  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c0100_ms' ,'disturbance',i,rval,texist)
        if(texist) fx_c0100_ms  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c1000_di' ,'disturbance',i,rval,texist)
        if(texist) fx_c1000_di  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c1000_ds' ,'disturbance',i,rval,texist)
        if(texist) fx_c1000_ds  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('fx_c1000_mi' ,'disturbance',i,rval,texist)
        if(texist) fx_c1000_mi  = sngloff(rval,tiny_offset)
        ...
        if(texist) ft_fint_upr  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('ft_fint_exp' ,'disturbance',i,rval,texist)
        if(texist) ft_fint_exp  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('ft_frag_exp' ,'disturbance',i,rval,texist)
        if(texist) ft_frag_exp  = sngloff(rval,tiny_offset)
        call getConfigREAL  ('ft_lu_upr'   ,'disturbance',i,rval,texist)
        if(texist) ft_lu_upr    = sngloff(rval,tiny_offset)
        call getConfigREAL  ('ft_lu_exp'   ,'disturbance',i,rval,texist)
        if(texist) ft_lu_exp    = sngloff(rval,tiny_offset)
        call getConfigREAL  ('ft_hdi_upr'  ,'disturbance',i,rval,texist)
        if(texist) ft_hdi_upr   = sngloff(rval,tiny_offset)
        ...
        !!      know how to add them, feel free to add them.
  ...
  if(ntag .ge. 1) then
     do i=1,ntag
        ...
        if(texist)  root_phen_factor = sngloff(rval,tiny_offset)
        call getConfigREAL  ('f_psi_xdry','phenology',i,rval,texist)
        if(texist)  f_psi_xdry = sngloff(rval,tiny_offset)
        call getConfigREAL  ('elongf_min','phenology',i,rval,texist)
        if(texist)  elongf_min = sngloff(rval,tiny_offset)
        call getConfigREAL  ('elongf_flush','phenology',i,rval,texist)
        if(texist)  elongf_flush = sngloff(rval,tiny_offset)
        ...
        if(texist)  turnamp_window = sngloff(rval,tiny_offset)
        call getConfigREAL  ('turnamp_min','phenology',i,rval,texist)
        if(texist)  turnamp_min = sngloff(rval,tiny_offset)
        call getConfigREAL  ('turnamp_max','phenology',i,rval,texist)
        if(texist)  turnamp_max = sngloff(rval,tiny_offset)
        call getConfigREAL  ('llspan_window','phenology',i,rval,texist)
        if(texist)  llspan_window = sngloff(rval,tiny_offset)
        call getConfigREAL  ('llspan_min','phenology',i,rval,texist)
        if(texist)  llspan_min = sngloff(rval,tiny_offset)
        call getConfigREAL  ('llspan_max','phenology',i,rval,texist)
        if(texist)  llspan_max = sngloff(rval,tiny_offset)
        call getConfigREAL  ('vm0_window','phenology',i,rval,texist)
        if(texist)  vm0_window = sngloff(rval,tiny_offset)
        call getConfigREAL  ('vm0_tran','phenology',i,rval,texist)
        if(texist)  vm0_tran = sngloff(rval,tiny_offset)
        call getConfigREAL  ('vm0_slope','phenology',i,rval,texist)
        if(texist)  vm0_slope = sngloff(rval,tiny_offset)
        call getConfigREAL  ('vm0_amp','phenology',i,rval,texist)
        if(texist)  vm0_amp = sngloff(rval,tiny_offset)
        call getConfigREAL  ('vm0_min','phenology',i,rval,texist)
        if(texist)  vm0_min = sngloff(rval,tiny_offset)
        call getConfigREAL  ('sla_window','phenology',i,rval,texist)
        if(texist)  sla_window = sngloff(rval,tiny_offset)
...
!! MORTALITY
        ...
        call putConfigREAL("escorch"           ,escorch      (i))
...
!! PLANT HYDRAULICS
        ...
        call putConfigREAL("bark_water_sat"    ,bark_water_sat    (i))
  ...
  call libxml2f90_ll_opentag("decomposition")
     ...
     call putConfigREAL("r_stsc_l"                 ,r_stsc_l                 )
     call putConfigREAL("r_stsc_o"                 ,r_stsc_o                 )
     ...
     call putConfigREAL("rh_moyano12_a0"           ,rh_moyano12_a0           )
     call putConfigREAL("rh_moyano12_a1"           ,rh_moyano12_a1           )
     call putConfigREAL("rh_moyano12_a2"           ,rh_moyano12_a2           )
     call putConfigREAL("rh_active_depth"          ,rh_active_depth          )
     call putConfigREAL("rh0"                      ,rh0                      )
     call putConfigREAL("rh_q10"                   ,rh_q10                   )
     call putConfigREAL("rh_p_smoist"              ,rh_p_smoist              )
     call putConfigREAL("rh_p_oxygen"              ,rh_p_oxygen              )
  ...
  call libxml2f90_ll_opentag("disturbance")
     ...
     call putConfigREAL("fi_lu_exp"             ,fi_lu_exp             )
     ...
     call putConfigREAL("fs_smpot_lwr"          ,fs_smpot_lwr          )
     call putConfigREAL("fs_smpot_upr"          ,fs_smpot_upr          )
     call putConfigREAL("fs_smpot_exp"          ,fs_smpot_exp          )
     call putConfigREAL("fs_temp_lwr"           ,fs_temp_lwr           )
     call putConfigREAL("fs_temp_upr"           ,fs_temp_upr           )
     ...
     call putConfigReal("fx_a0100"              ,fx_a0100              )
     call putConfigReal("fx_rmfac"              ,fx_rmfac              )
     call putConfigReal("fx_tlh_slope"          ,fx_tlh_slope          )
     call putConfigReal("fx_tlc_slope"          ,fx_tlc_slope          )
     call putConfigReal("fx_pmtau_di"           ,fx_pmtau_di           )
     call putConfigReal("fx_pmtau_ds"           ,fx_pmtau_ds           )
     call putConfigReal("fx_c0001_di"           ,fx_c0001_di           )
     call putConfigReal("fx_c0001_ds"           ,fx_c0001_ds           )
     call putConfigReal("fx_c0001_mi"           ,fx_c0001_mi           )
     call putConfigReal("fx_c0001_ms"           ,fx_c0001_ms           )
     call putConfigReal("fx_c0010_di"           ,fx_c0010_di           )
     call putConfigReal("fx_c0010_ds"           ,fx_c0010_ds           )
     call putConfigReal("fx_c0010_mi"           ,fx_c0010_mi           )
     call putConfigReal("fx_c0010_ms"           ,fx_c0010_ms           )
     call putConfigReal("fx_c0100_di"           ,fx_c0100_di           )
     call putConfigReal("fx_c0100_ds"           ,fx_c0100_ds           )
     call putConfigReal("fx_c0100_mi"           ,fx_c0100_mi           )
     call putConfigReal("fx_c0100_ms"           ,fx_c0100_ms           )
     call putConfigReal("fx_c1000_di"           ,fx_c1000_di           )
     ...
     call putConfigREAL("ft_frag_exp"           ,ft_frag_exp           )
     call putConfigREAL("ft_lu_upr"             ,ft_lu_upr             )
     call putConfigREAL("ft_lu_exp"             ,ft_lu_exp             )
  ...
  call libxml2f90_ll_opentag("phenology")
     ...
     call putConfigREAL("root_phen_factor"        ,root_phen_factor        )
     call putConfigREAL("f_psi_xdry"              ,f_psi_xdry              )
     call putConfigREAL("elongf_min"              ,elongf_min              )
     call putConfigREAL("elongf_flush"            ,elongf_flush            )
     ...
     call putConfigREAL("turnamp_max"             ,turnamp_max             )
     call putConfigREAL("llspan_window"           ,llspan_window           )
     call putConfigREAL("llspan_min"              ,llspan_min              )
     call putConfigREAL("llspan_max"              ,llspan_max              )
     call putConfigREAL("vm0_window"              ,vm0_window              )
     call putConfigREAL("vm0_tran"                ,vm0_tran                )
     call putConfigREAL("vm0_slope"               ,vm0_slope               )
     call putConfigREAL("vm0_amp"                 ,vm0_amp                 )
     call putConfigREAL("vm0_min"                 ,vm0_min                 )
     call putConfigREAL("sla_window"              ,sla_window              )
