...
! mortality
           ...
           call getConfigREAL  ('fire_s_efac','pft',i,rval,texist)
           if(texist) fire_s_efac(myPFT) = sngloff(rval,tiny_offset)
...
!        call getConfigREAL  ('ntol','fusefiss',i,rval,texist)
  ...
  if(ntag .ge. 1) then
     do i=1,ntag
        ...
        call getConfigREAL  ('fi_hdi_lwr'  ,'disturbance',i,rval,texist)
        if(texist) fi_hdi_lwr   = sngloff(rval,tiny_offset)
        ...
        call getConfigREAL  ('ft_hdi_lwr'  ,'disturbance',i,rval,texist)
        if(texist) ft_hdi_lwr   = sngloff(rval,tiny_offset)
        ...
        call getConfigREAL  ('ft_fdi_upr'  ,'disturbance',i,rval,texist)
        if(texist) ft_fdi_upr   = sngloff(rval,tiny_offset)
        call getConfigREAL  ('ft_fdi_exp'  ,'disturbance',i,rval,texist)
        if(texist) ft_fdi_exp   = sngloff(rval,tiny_offset)
...
!! MORTALITY
        ...
        call putConfigREAL("fire_s_efac"       ,fire_s_efac  (i))
...
!! PLANT HYDRAULICS
  ...
  call libxml2f90_ll_opentag("disturbance")
     ...
     call putConfigREAL("fi_hdi_lwr"            ,fi_hdi_lwr            )
     ...
     call putConfigREAL("ft_hdi_lwr"            ,ft_hdi_lwr            )
     call putConfigREAL("ft_hdi_upr"            ,ft_hdi_upr            )
     call putConfigREAL("ft_hdi_exp"            ,ft_hdi_exp            )
     call putConfigREAL("ft_fdi_upr"            ,ft_fdi_upr            )
     call putConfigREAL("ft_fdi_exp"            ,ft_fdi_exp            )
