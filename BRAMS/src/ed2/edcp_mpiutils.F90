...
subroutine masterput_ednl(mainnum)
   ...
   call MPI_Bcast(ndfire,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   ...
   do ng=1,maxgrds
      ...
      call MPI_Bcast(sei_database   (ng),str_len,MPI_CHARACTER,mainnum,MPI_COMM_WORLD,ierr)
      call MPI_Bcast(flash_database (ng),str_len,MPI_CHARACTER,mainnum,MPI_COMM_WORLD,ierr)
   end do
   ...
   call MPI_Bcast(slsoc,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(slph,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(slcec,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(sldbd,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
...
subroutine nodeget_ednl(master_num)
   ...
   call MPI_Bcast(ndfire,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   ...
   do ng=1,maxgrds
      ...
      call MPI_Bcast(sei_database   (ng),str_len,MPI_CHARACTER,master_num,MPI_COMM_WORLD,ierr)
      call MPI_Bcast(flash_database (ng),str_len,MPI_CHARACTER,master_num,MPI_COMM_WORLD,ierr)
   end do
   ...
   call MPI_Bcastslsoc,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcastslph,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcastslcec,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcastsldbd,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
